...
public class HatJson {
    ...
    private static final List<HatEntry> defaultHats = Arrays.asList(
            ...
            new HatEntry("blankhat", Rarity.RARE, 0, 0),
            ...
            new HatEntry("ushanka_dark", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("antler", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("antlersmall", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("broken", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("bull", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("demon", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("demondown", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("devil", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("goat", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("imp", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("imptall", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("ram", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("ravager", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("talltrio", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
            new HatEntry("tiefling", Rarity.RARE, 5, 0, new HatEntry.HatDyeSettings(true, 16383998)),
