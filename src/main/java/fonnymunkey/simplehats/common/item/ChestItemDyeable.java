...
public class ChestItemDyeable extends ChestItem implements DyeableItem {

    public ChestItemDyeable(ChestEntry entry) {
        super(entry);
    }
    ...
    public int getColor(ItemStack stack) {
        ...
        return compoundtag != null && compoundtag.contains("color", 99) ? compoundtag.getInt("color") : this.getChestEntry().getChestDyeSettings().getColorCode();
    }
