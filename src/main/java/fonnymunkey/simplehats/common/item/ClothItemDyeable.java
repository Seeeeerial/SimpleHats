...
public class ClothItemDyeable extends ClothItem implements DyeableItem {

    public ClothItemDyeable(ClothEntry entry) {
        super(entry);
    }
    ...
    public int getColor(ItemStack stack) {
        ...
        return compoundtag != null && compoundtag.contains("color", 99) ? compoundtag.getInt("color") : this.getClothEntry().getClothDyeSettings().getColorCode();
    }
