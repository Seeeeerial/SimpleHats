...
public class TailItemDyeable extends TailItem implements DyeableItem {

    public TailItemDyeable(TailEntry entry) {
        super(entry);
    }
    ...
    public int getColor(ItemStack stack) {
        ...
        return compoundtag != null && compoundtag.contains("color", 99) ? compoundtag.getInt("color") : this.getTailEntry().getTailDyeSettings().getColorCode();
    }
